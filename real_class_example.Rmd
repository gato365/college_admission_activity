...
Create a data frame by selecting the columns that Are imperative to Amber's preference. Use an underscore, '_', rather than a space, ' '. Make sure to use correct spelling. 
...
### Filter based on ACT Composite Scores
...
act_amber_pref_df = filter(amber_pref_df,  ACT_Composite <= 32 )
```
