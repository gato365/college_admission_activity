...
**Change the mathematical expression, $<=$, so that you have a data frame that has songs strictly less than 4 minutes.** Press *Submit Answer* when your complete.
...
question("What is the purpose of the filter function? ",
         answer("Filter rows that satisfies a condition", correct = TRUE),
...
**Erase write expression to filter schools that will accept her score or less. (Hint: use ACT_Score)**
...
Thank you for completing this program. Please visit GATO365.com for more content.