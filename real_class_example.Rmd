...
```{r amber_pref_Q10, exercise = TRUE, exercise.eval = FALSE}
amber_pref_df =  select(oos_city_college_df,1st_column_name,2nd_column_name,3rd_column_name)
```



```{r amber_pref_Q10-solution}
select(oos_city_college_df,School_Name,ACT_Composite,Price_OOS_LOC)
```

```{r amber_pref_Q10-check}
