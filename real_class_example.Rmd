...
Amber is only interested in the school name, ACT Composite, and Out of state tuition. Amber also did better on her ACTs compared to her SATs so she only submitted her ACTs score where her composite score was a 32. 
...
### Look Over Amber's Data Frame of Schools
```{r amber_pref_Q12_num, exercise = TRUE, exercise.eval = FALSE}
act_amber_pref_df
```
