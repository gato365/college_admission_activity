...
Amber is only interested in the school name, Admissions, ACT Composite, Out of state tuitionate. Amber also did better on her ACTs compared to her SATs so she only submitted her ACTs score where her composite score was a 32. 
...
Create a data frame by selecting the columns that Are imperative to Amber's preference. Use an underscore, '_', rather than a space, ' '. Make sure to type column names in the quotes using correct spelling. 
```{r amber_pref_Q8, exercise = TRUE, exercise.eval = FALSE}
amber_pref select(city_college_df,'1st_column_name','2nd_column_name','3rd_column_name')
```
